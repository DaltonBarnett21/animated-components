...
export const inputVariants = cva(
  "flex w-full mt-[4px] mb-[2px] relative bg-white-50 rounded-md outline-none border border-gray-400 transition-all duration-300   placeholder:text-muted-foreground ",
  {
    variants: {
      variant: {
        default: "",
      ...
      disabled: {
        true: "bg-gray-100 border-none text-gray-400",
      },
      readonly: {
        true: "outline-none font-medium  border-t-0 border-l-0 border-r-0 rounded-none border-b-gray-400",
      },
      error: {
